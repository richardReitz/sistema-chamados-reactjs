...
import { FiClipboard, FiPlus, FiEdit2, FiSearch } from "react-icons/fi";
                  ...
                  return(
                    <tr key={index}>
                      ...
                      <td data-label="Status">
                        <span className='badge' style={{backgroundColor: item.status === 'Aberto' || item.status === 'Progresso' ? "#5cb85c" : "#999"}}>{item.status}</span>
                      </td>
